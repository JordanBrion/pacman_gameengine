...
void Scene3dRenderer::initResources()
{
    ...
    xxffi::init_resources(&m_context);
...
//    // Shaders
//    VkShaderModule vertShaderModule = createShader(QStringLiteral("/home/jordanbrion/Documents/rust/vulkan-samples/shaders/003_swapchain.vert.spv"));
//    VkShaderModule fragShaderModule = createShader(QStringLiteral("/home/jordanbrion/Documents/rust/vulkan-samples/shaders/003_swapchain.frag.spv"));
//    // Graphics pipeline
