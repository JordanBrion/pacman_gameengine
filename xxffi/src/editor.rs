...
//     v_swapchain_images: Vec<ash::vk::Image>,
//     v_swapchain_image_views: Vec<ash::vk::ImageView>,
//     v_framebuffers: Vec<ash::vk::Framebuffer>,
//     vertex_buffer: ash::vk::Buffer,
// }

// impl Default for VulkanContext {
//     fn default() -> VulkanContext {
//         VulkanContext {
//             instance: ash::Instance { ..Default::default() },
//             gpu: ash::vk::PhysicalDevice::null(),
//             index_of_queue_family: !(0),
//             logical_device: ash::vk::Device::null(),
//             queue: ash::vk::Queue::null(),
//             graphics_pipeline: ash::vk::Pipeline::null(),
//             v_swapchain_images: Default::default(),
//             v_swapchain_image_views: Default::default(),
//             v_framebuffers: Default::default(),
//             vertex_buffer: ash::vk::Buffer::null(),
//         }
//     }
// }
...
//         self.gpu = self.pick_up_one_gpu().expect("Cannot find GPU");
//         // self.index_of_queue_family =
//         // Self::lookup_queue_family_index(&gpu).expect("Cannot find graphics queue family");
//         // self.logical_device = Self::create_logical_device(&gpu, index_of_queue_family)
//         //     .expect("Cannot create logical device");
//         //     self.queue = logical_device.get_device_queue(index_of_queue_family as u32, 0);
//         // self.v_swapchain_image_views = Self::create_image_views();
//         // self.graphics_pipeline = Self::create_graphics_pipeline(&logical_device);
//         // self.v_framebuffers = Self::create_frame_buffers();
//         // self.vertex_buffer = Self::create_vertex_buffer();
//     }

//     unsafe fn pick_up_one_gpu(&self) -> Option<ash::vk::PhysicalDevice> {
//         match self.instance.enumerate_physical_devices() {
...
// // //     fn create_graphics_pipeline(logical_device: &ash::Device) -> ash::vk::Pipeline {
...
// // //                 module: create_shader_module(&logical_device, "shaders/004_vertex_buffer.vert.spv"),
...
// // //                 module: create_shader_module(&logical_device, "shaders/004_vertex_buffer.frag.spv"),
// // //                 p_name: shader_entry_name.as_ptr(),
// // //                 p_specialization_info: std::ptr::null(),
// // //             },
// // //         ];
...
// // //         v_graphics_pipelines[0]
// // //     }

// // //     fn create_image_views() -> Vec<ash::vk::ImageView> {
...
// // //     fn create_frame_buffers() -> Vec<ash::vk::Framebuffer> {
...
// // //     fn create_vertex_buffer() -> ash::vk::Buffer {
...
// // //         // TODO pass surface present modes from QT
...
// // //         // TODO get swapchain images from QT
